                            ...
                            <div class="first-column">
                                <div class="email-section ">
                                    ...
                                    <div class="email-icon">
                                        <span>
                                            <img src="{{ asset('assets/web/images/user.svg') }}" alt=""
                                                srcset="">
                                        </span>
                                ...
                                <div class="email-section ">
                                    ...
                                    <span class="last_name"></span><span class="text-danger"
                                        id="contacttext-danger">{{ $errors->first('last_name') }}</span>
                                    {{-- @endif --}}
                                </div>
                                <div class="email-section">
                                    ...
                                    <div class="email-icon">
                                        <span>
                                            <img src="{{ asset('assets/web/images/Email.svg') }}" alt=""
                                                srcset="">
                                        </span>
                                ...
                                <div class="email-section">
                                    ...
                                    <div class="email-icon">
                                        <span>
                                            <img src="{{ asset('assets/web/images/phone.svg') }}" alt=""
                                                srcset="">
                                        </span>
                                        <input class="font-16" name="phone" type="text" maxlength="10"
                    ...
                    <div class="con-right-sec">
                        <div class="more-options-sec">
                            ...
                            <div class="second-column">
                                <div class="calls-sec">
                                    <img src="{{ asset('assets/web/images/con-phone.svg') }}" alt=""
                                        srcset="">
                                ...
                                <div class="calls-sec">
                                    <img src="{{ asset('assets/web/images/con-email.svg') }}" alt=""
                                        srcset="">
                            ...
                            {{-- <div class="loction-sec">
                                <div class="calls-sec">
                                    <img src="{{ asset('assets/web/images/con-location.svg') }}" alt=""
                                        srcset="">
