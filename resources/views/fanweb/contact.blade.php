        ...
        <div class="custom_container contact-section">
            <div class="tab-heading arrow-align">
                ...
                @if (Session::has('success'))
                    <div class="text-success" id="text-success" style="margin-right:41%">
                        {{ Session::get('success') }}
                        @php
                ...
                <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
                    <div class="con-left-sec">
                        ...
                        <div class="form-input-section">
                            {{-- <form action="{{ url('/fan/contactcreate') }}" class="contact-form-section" method="post">
                            @csrf
                            @method("POST") --}}
                            <div class="first-column">
                                <div class="email-section ">
                                    ...
                                    <div class="email-icon">
                                        <span>
                                            <img src="{{ asset('assets/fan/images/user.svg') }}" alt=""
                                                srcset="">
                                        </span>
                                        <input class="font-16" name="first_name" type="text"
                                ...
                                <div class="email-section ">
                                    ...
                                    <div class="email-icon">
                                        ...
                                        <input class="font-16" name="last_name" type="text" placeholder="Enter Last Name"
                                            value="{{ old('last_name') }}">
                                    </div>
                                ...
                                <div class="email-section">
                                    ...
                                    <div class="email-icon">
                                        ...
                                        <input class="font-16" name="email" type="email" placeholder="Enter Email"
                                            value="{{ old('email') }}">
                                    </div>
                                    {{-- @if ($errors->has('email')) --}}
                                ...
                                <div class="email-section">
                                    ...
                                    <div class="email-icon">
                                        <span>
                                            <img src="{{ asset('assets/fan/images/phone.svg') }}" alt=""
                                                srcset="">
                                        </span>
                                        <input class="font-16" name="phone" type="text" placeholder="Enter Phone"
                            ...
                            <div class="con-text-area">
                                ...
                                <div class="commentss"></div>
                                {{-- @endif --}}


                            </div>
                            <div class="login-btn con-form-btn">
                                <button type="submit" class="font-16" id="contact">Submit</button>
                            </div>
                            {{-- </form> --}}
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                    <div class="con-right-sec">
                        ...
                        {{-- <div class="map-section">
                            <iframe src="{{ $contactdetail->map }}" width="100%" height="430" frameborder="0"
...
@section('footer')
    <script>
        $(document).ready(function() {
            ...
            if (localStorage.getItem("contactsave")) {
                toastr.success("Support Request Received");
                localStorage.clear();
            }
            ...
            $(document).on("click", "#contact", function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'phone': phone,
                        'comments': comments
                    }, // Setting the data attribute of ajax with form_data
                    success: function(data) {
                        ...
                        //   timer: 1500
                        // })
                        localStorage.setItem("contactsave", data['message']);
                        location.reload();
                    },
                    error: function(data) {
