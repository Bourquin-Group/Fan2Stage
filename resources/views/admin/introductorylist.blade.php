            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="button-right">
                  <a href="introductory/add"><button type="button" class="btn btn-primary">
                      Add Introductory 
                    </button></a></div>
                <div class="card-body">
                 ...
                 <!--  <h5 class="card-title">Introductory List</h5> -->
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tbody>
                      	<?php foreach ($introductory as $value) {
                          if($value->image !=''){
                          $url = asset('assets/images/introductory/thumbnail/'.$value->image);}
                          else{
                          ...
                          <td><?php if($value->status == 1) {?> <span class='badge badge-success'>Active</span><?php } else{ ?><span class='badge badge-danger'>Deactive</span><?php }?></td>
                           <td>
                              <a href="{{url('/admin/introductoryedit/'.base64_encode($value->id))}}"><button type="button" class="btn btn-info btn-sm">
                              Edit</button></a>
                              <a href="{{url('/admin/deleteintroductory/'.base64_encode($value->id))}}" onclick="return confirm(' you want to delete?');"><button type="button" class="btn btn-danger btn-sm text-white">Delete</button></a>
                            </td>
                        </tr>
