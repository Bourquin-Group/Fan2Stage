          ...
          <div id="loginform">
            ...
            @foreach($errors->all() as $error)              
                <div class="alert alert-error alert-dismissible fade show" role="alert">
                                            <i class="fas fa-check-circle"></i><strong class="px-2">{{ $error }}</strong>
              ...
              <div class="row pb-4">
                <div class="col-12">
                  <div class="input-group mb-3">
                    ...
                    <input
                      type="email" id="email" name="email" value="{{ old('email') }}" required="required" autocomplete="email" autofocus="autofocus"
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input id="password" name="password" required="required" autocomplete="current-password"
                      type="password"
              ...
              <div class="row border-top border-secondary">
                <div class="col-12">
                  <div class="form-group">
                    <div class="pt-3"><!-- <a href="http://127.0.0.1:8000/password/reset" class="btn btn-link">
                                        Forgot Your Password?
                                    </a> -->
                      <a href="{{url('/password/reset')}}" class="btn btn-link"><button
                        class="btn btn-info"
                        id="to-recover"
                        type="button"
                      >
