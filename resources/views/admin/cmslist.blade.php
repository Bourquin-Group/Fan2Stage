            ...
            <div class="col-12">
              ...
              <div class="card">
                <!-- <div class="button-right">
                  <a href="cms/add"><button type="button" class="btn btn-primary">
                      Add CMS 
                    </button></a></div> -->
                <div class="card-body">

                  <!-- <h5 class="card-title">CMS Page List</h5> -->
                    ...
                    >
                      ...
                      <tbody>
                          ...
                          <td><?php if($value->status == 1) {?> <span class='badge badge-success'>Active</span><?php } else{ ?><span class='badge badge-danger'>Deactive</span><?php }?></td>
                           <td>
                              <a href="{{url('/admin/cmsedit/'.base64_encode($value->id))}}"><button type="button" class="btn btn-info btn-sm">
                              Edit</button></a>
